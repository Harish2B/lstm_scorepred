...
def train_lstm_model(dataframes):
    ...
    model.add(Dense(units=data.shape[1], activation='linear'))  # Output layer for failure likelihood score
    ...
    model.compile(loss=custom_loss, optimizer='RMS prop')  # RMS prop works properly
...
# Example usage:
dataframes = [
    pd.read_excel('C:/Users/haris/OneDrive/Desktop/NCV/datasets/Alert prediction data.xlsx'),
